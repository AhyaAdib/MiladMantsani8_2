...
export default function Navbar()
{
    ...
    const toggleMenu = () => {
        const menuToggle = document.querySelector('.tombolMenu')
    ...
    return (
        <>
        <header id="navbar" style={{visibility: 'visible'}}>
            <a href="#" className="logoNav"><img src="/assets/img/title.png" href="/" onClick={toggleMenu} height="36px"/></a>
            <div className="tombolMenu" onClick={toggleMenu}></div>
            <ul className="navigasi">
                <li><a href="/#banner" onClick={toggleMenu}>
                    <svg clasName="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
